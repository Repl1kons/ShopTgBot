...
async def start_send_photo_more(bot, chat_id, more_text, db):
    ...
    await install_image(bot, chat_id, more_dir, path_name, product_name, more_text, db)
...
async def install_image(bot, chat_id, folder_id, path_name, product_name, path_text, db):
    ...
    download_path = f"photo/{product_name}/{path_name}"
